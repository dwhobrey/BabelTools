...
static const byte s_vecUpper[] = "ABCDEFGHJKLMNPQRSTUVWXYZ23456789"; //DJRW: Note replaced I by L.
static const byte s_vecLower[] = "abcdefghjklmnpqrstuvwxyz23456789";
...
void Base32Encoder::IsolatedInitialize(const NameValuePairs &parameters)
{
	...
	m_filter->Initialize(CombinedNameValuePairs(
		...
		uppercase ? &s_vecUpper[0] : &s_vecLower[0], false)
...
void Base32Decoder::IsolatedInitialize(const NameValuePairs &parameters)
{
	BaseN_Decoder::Initialize(CombinedNameValuePairs(
		parameters,
		MakeParameters(Name::DecodingLookupArray(), GetDefaultDecodingLookupArray(), false)
		(Name::Log2Base(), 5, true)));
}
